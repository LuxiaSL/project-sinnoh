"""Pokemon species data for Gen 4 (Platinum).

National Dex ID -> (name, type1, type2 or None).
All 493 species through Arceus.
Types reflect Gen 4 (no Fairy type exists yet).
"""

from __future__ import annotations


# Species ID -> (name, type1, type2_or_None)
SPECIES: dict[int, tuple[str, str, str | None]] = {
    ...
    173: ("Cleffa", "Normal", None),
    174: ("Igglybuff", "Normal", None),
    175: ("Togepi", "Normal", None),
    ...
    280: ("Ralts", "Psychic", None),
    281: ("Kirlia", "Psychic", None),
    282: ("Gardevoir", "Psychic", None),
